...
const TARGETS: Record<string, string[]> = {
  ...
  os_session_detail_activity_heading: ["Con sẽ làm gì?"],
  os_session_detail_skills_heading: ["Con sẽ khám phá"],
  os_detail_skill_heading: ["Điều con sẽ học"],
  os_detail_register_cta: ["Đăng ký tham gia", "Đăng ký buổi này"],
  ...
  os_booking_submit: ["Gửi đăng ký →", "Gửi đăng ký"],
  os_booking_success_title: ["PINO đã nhận đăng ký 🎉", "Đã nhận đăng ký"],
  os_booking_success_description: ["Cảm ơn bạn. PINO sẽ liên hệ qua Zalo để xác nhận ngày, giờ và chỗ trống cho bé.", "PINO sẽ liên hệ với ba mẹ để xác nhận buổi tham gia và hướng dẫn chuẩn bị."],
  os_registration_disabled: ["Đăng ký trực tuyến sắp mở"],
