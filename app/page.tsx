    ...
    <main className={styles.page} id="top">
      <div className={styles.shell}>
        ...
        <footer className={styles.footer} id="about">
          <div className={styles.footerLead}><a className={styles.footerBrand} href="#top"><img src={SIGIL} alt="" /><span>PINO House</span></a><p><L vi="Nghệ thuật. Âm nhạc. Lớn lên sáng tạo." en="Art. Music. Creative Growth." /></p><strong>pinohouse.art</strong><p className={styles.notifierNote}>PINO Notifier is the email notification service operated by PINO House.</p></div>
          ...
          <div className={styles.footerCol}><h4><L vi="Thông tin" en="Information" /></h4><a href="/open-studio"><L vi="Đến thăm" en="Visit" /></a><a href="#about">FAQs</a><a href="/policy"><L vi="Chính sách bảo mật" en="Privacy Policy" /></a><a href="/term"><L vi="Điều khoản dịch vụ" en="Terms of Service" /></a><a href="#about"><L vi="Liên hệ" en="Contact" /></a></div>
